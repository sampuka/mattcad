...
_OBJ = mattcad.o Mattcad.o Entity.o VarSetEntity.o EvaluationEntity.o
...
$(ODIR)/Mattcad.o: $(SDIR)/Mattcad.cpp $(IDIR)/Mattcad.hpp $(IDIR)/Entity.hpp $(IDIR)/VarSetEntity.hpp $(IDIR)/EvaluationEntity.hpp
	$(CC) -c -o $(ODIR)/Mattcad.o $(CFLAGS) $(SDIR)/Mattcad.cpp

$(ODIR)/Entity.o: $(SDIR)/Entity.cpp $(IDIR)/Entity.hpp
	$(CC) -c -o $(ODIR)/Entity.o $(CFLAGS) $(SDIR)/Entity.cpp

$(ODIR)/VarSetEntity.o: $(SDIR)/VarSetEntity.cpp $(IDIR)/VarSetEntity.hpp $(IDIR)/Entity.hpp
	$(CC) -c -o $(ODIR)/VarSetEntity.o $(CFLAGS) $(SDIR)/VarSetEntity.cpp

$(ODIR)/EvaluationEntity.o: $(SDIR)/EvaluationEntity.cpp $(IDIR)/EvaluationEntity.hpp $(IDIR)/Entity.hpp
	$(CC) -c -o $(ODIR)/EvaluationEntity.o $(CFLAGS) $(SDIR)/EvaluationEntity.cpp
